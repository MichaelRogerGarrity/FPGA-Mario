...
Figure 3: python script that converts .csv that has the 16x16 palette base 10 indices into a formatted .txt file with hex values 
...
leds_pio: This PIO module is the PIO for our LEDs. It creates the exported 14-bit conduit signal LEDs which were not used but we left in. 
